...
public class DifficultyScreen extends InputAdapter implements Screen {
    ...
    public void show() {
        ...
        font = new BitmapFont();
        font.getData().scale(Constants.DIFFICULTY_LABEL_SCALE);
    ...
    public void render(float delta) {
        ...
        renderer.circle(Constants.EASY_CENTER.x, Constants.EASY_CENTER.y, Constants.DIFFICULTY_BUBBLE_RADIUS,Constants.DIFFICULTY_SEGMENTS);

        renderer.setColor(Constants.MEDIUM_COLOR);
        renderer.circle(Constants.MEDIUM_CENTER.x, Constants.MEDIUM_CENTER.y, Constants.DIFFICULTY_BUBBLE_RADIUS,Constants.DIFFICULTY_SEGMENTS);

        renderer.setColor(Constants.HARD_COLOR);
        renderer.circle(Constants.HARD_CENTER.x, Constants.HARD_CENTER.y, Constants.DIFFICULTY_BUBBLE_RADIUS,Constants.DIFFICULTY_SEGMENTS);
